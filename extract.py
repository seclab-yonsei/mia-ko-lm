...
def define_logger(config: argparse.Namespace) -> None:
    ...
    # logging.basicConfig(level=level, format=log_format, stream=sys.stderr, filename="log.log", filemode="w")
...
def main(config):
    ...
    # model, tokenizer = GenerativeLanguageModel.get_model_and_tokenizer("kykim/gpt3-kor-small_based_on_gpt2")
